...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'kuajing12345', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '利用国际互联网加速实现财务自由', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.kuajing12345.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '跨境电商从这里开始', // 网站关键词 英文逗号隔开
